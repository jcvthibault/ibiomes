...
case 5:
case 7:
for (var d = 0; d < 4; d++) if (this.rule4List[d] != null && this.atoms[d].atom != null && !this.atoms[d].isTerminal) this.atoms[d].sortSubstituents (-2147483648);
...
var g;
if (this.b$["JS.CIPChirality"].currentRule == 99) for (var h = 0; h < 4; h++) {
var i = this.atoms[h];
if (!i.isTerminal && i.atom != null && !i.isDuplicate) i.sortSubstituents (a);
}
for (var i = 0; i < 4; i++) {
var j = this.atoms[i];
for (var k = i + 1; k < 4; k++) {
var l = this.atoms[f = k];
switch (j.atom == null ? 1 : l.atom == null ? -1 : d[i] < d[k] ? -1 : d[k] < d[i] ? 1 : (g = this.checkPriority (j, l, i, k)) != 0 ? g : b ? -2147483648 : this.sign (j.breakTie (l, a + 1))) {
case 1:
f = i;
this.priorities[f]++;
break;
...
for (var l = 0; l < 4; l++) {
var m = c[l];
var n = this.newAtoms[m] = this.atoms[l];
...
Clazz.defineMethod (c$, "checkRule4b", 
 function (a) {
...
Clazz.defineMethod (c$, "getBS4b", 
 function () {
if (this.bsR == null) this.bsR = this.getBS4bBreadth (1);
if (this.bsS == null) this.bsS = this.getBS4bBreadth (2);
var a = this.compareLikeUnlike (this.bsR, this.bsS);
return (a == null ? this.bsR : a);
});
...
var b = this.getBreadthBitSet (a);
this.b$["JS.CIPChirality"].currentRule = 6;
return b;
}, "~N");
Clazz.defineMethod (c$, "getBreadthBitSet", 
 function (a) {
var b = this.b$["JS.CIPChirality"].root.rule4bQueue;
if (b == null) b = this.b$["JS.CIPChirality"].root.rule4bQueue =  new JU.Lst ();
 else b.clear ();
var c = 0;
b.addLast (this);
var d =  new JU.BS ();
if (this.rule4Type == a) d.set (0);
c = 1;
while (b.size () != 0) {
var e = b.removeItemAt (0);
var f = e.newAtoms;
if (f == null) f = e.atoms;
if (f != null) for (var g = 0; g < 4; g++) {
var h = f[g];
if (h == null || h.atom == null || h.isTerminal || h.isDuplicate) continue;
b.addLast (h);
if (h.rule4Type == a) d.set (c);
c++;
}
}
return d;
...
Clazz.defineMethod (c$, "checkRule5", 
 function (a) {
if (this.bsR == null || a.bsR == null) return 0;
var b = this.compareLikeUnlike (this.bsR, a.bsR);
return (b == null ? -2147483648 : b === this.bsR ? -1 : 1);
}, "JS.CIPChirality.CIPAtom");
...
c = d + c;
if (JU.Logger.debugging && !c.equals ("~")) {
