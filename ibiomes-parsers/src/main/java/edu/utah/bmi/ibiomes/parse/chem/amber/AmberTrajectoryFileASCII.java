...
/**
 * AMBER ASCII trajectory file
 * @author Julien Thibault
 *
 */
public class AmberTrajectoryFileASCII extends AbstractTrajectoryFile
{
	 ...
	 * @throws IOException 
	 */
	public AmberTrajectoryFileASCII(String path) throws IOException
	{
		super(path, FORMAT_AMBER_TRAJ_ASCII);
	}
