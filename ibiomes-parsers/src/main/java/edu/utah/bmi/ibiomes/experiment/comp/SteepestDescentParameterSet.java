...
public class SteepestDescentParameterSet extends MinimizationParameterSet
{	
	/**
	 * Constructor
	 */
	public SteepestDescentParameterSet(){
		super(ParameterSet.METHOD_STEEPEST_DESCENT);
	}
	 ...
	 */
	public SteepestDescentParameterSet(int numberOfIterations){
		super(ParameterSet.METHOD_STEEPEST_DESCENT, numberOfIterations);
	}
