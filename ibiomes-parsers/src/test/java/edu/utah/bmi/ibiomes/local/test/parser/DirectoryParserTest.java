...
public class DirectoryParserTest {
	...
	private final Logger logger = Logger.getLogger(DirectoryParserTest.class);
	...
	public DirectoryParserTest() throws Exception{
	...
	public void testConvertGaussian() throws Exception
	{
		...
		try{
			for (int f=0; f<gaussianCollections.length; f++)
			{
				...
				DirectoryParser parser  = new DirectoryParser(gaussianCollections[f]);
	...
	public void testConvertNWChem() throws Exception
	{
		try{
			for (int f=0; f<nwchemCollections.length; f++)
			{
				...
				DirectoryParser parser  = new DirectoryParser(nwchemCollections[f]);
	...
	public void testConvertGamess() throws Exception
	{
		try{
			for (int f=0; f<gamessCollections.length; f++)
			{
				...
				DirectoryParser parser  = new DirectoryParser(gamessCollections[f]);
	...
	public void testConvertAmber() throws Exception
	{
		try{
			for (int f=0; f<amberCollections.length; f++)
			{
				...
				DirectoryParser parser  = new DirectoryParser(amberCollections[f]);
	...
	public void testConvertGromacs() throws Exception
	{
		try{
			for (int f=0; f<gromacsCollections.length; f++)
			{
				...
				DirectoryParser parser  = new DirectoryParser(gromacsCollections[f]);
