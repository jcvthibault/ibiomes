...
public class LinePlot 
{
	...
	/**
	 * Initialize new line plot
	 * @param csv CSV file
	 */
	public LinePlot(ColumnDataFile csv){
		csvParser = csv;
	}
	 ...
	 * @return Plot object
	 */
	public JFreeChart createLinePlot(
			...
			boolean logX, boolean logY) 
	{
		...
		//set series colors and check for negative values (to enable log scales or not)
