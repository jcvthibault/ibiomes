...
/**
 * Query builder for iBIOMES data
 * @author Julien Thibault, University of Utah
 *
 */
public class IBIOMESExperimentSearch extends IBIOMESAbstractSearch {

	private String collectionName;
	private long experimentSetId = -1;
	 ...
	 */
	public IBIOMESExperimentSearch(
	...
	{
		logger.debug("[SEARCH] Compile experiment search query");
		...
		queryBuilder.addConditionAsGenQueryField(RodsGenQueryEnum.COL_META_COLL_ATTR_NAME , QueryConditionOperators.LIKE , GeneralMetadata.IBIOMES_FILE_TYPE );
		queryBuilder.addConditionAsGenQueryField(RodsGenQueryEnum.COL_META_COLL_ATTR_VALUE, QueryConditionOperators.LIKE , BiosimMetadata.DIRECTORY_EXPERIMENT);
	...
	public long getExperimentSetId() {
		return experimentSetId;
	}

	public void setExperimentSetId(long experimentSetId) {
